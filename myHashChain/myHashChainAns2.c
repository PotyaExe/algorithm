		...
		switch (item) {
			...
			case 3 : //Search data
				// you can write program here!
                        printf("Input data you wannna search = "); 
		            scanf("%d",&data);
                        searchTable(&table[myHash(data)], data);      
                        break;

			case 4 : // Delete data
				// you can write program here!
                        printf("Input data you wannna delete = ");
                        deleteTable(&table[myHash(data)],data);
				break;
...
void searchTable(CELL **p,int data){
